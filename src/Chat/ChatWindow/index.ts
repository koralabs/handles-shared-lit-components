            ...
            <div class="chat-window ${this.isOpen ? 'open' : 'closed'}">
                ...
                <div class="chat-body">
                    <div class="chats-wrapper">
                      <chat-box .isMe=${this.isMe} .chatText=${this.chatText} .imageUrl=${'https://public-handles.myfilebase.com/ipfs/zb2rhiv8WgRqPrRKYuHic1NsXHmgNKFyojuc81E5qFWFWLaQn?img-width=100'}></chat-box>
                    </div>
                </div>
