...
export class ChatInput extends LitElement {
    ...
    @property({ type: String }) inputValue: string | 'aa'
    @property({ type: Boolean }) isMe = true



    sendChat() {
        const content = this.shadowRoot.getElementById('idiot').innerHTML.trim()
        this.isMe = true
    ...
    render() {
        return html`
            <div class="chat-container" >
                <div id="idiot" class="chat-input" autocomplete="off" autocorrect="off" spellcheck="true" aria-expanded="false" aria-autocomplete="list" aria-multiline="true" aria-label="Message" dir="auto" contenteditable="true" role="textbox">
                    ${this.chatText}
                </div>
