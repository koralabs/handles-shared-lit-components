...
export const Page = ({ user, onLogin, onLogout, onCreateAccount }: PageProps) => html`
    ...
    onCreateAccount
        ...
        <section class="storybook-page">
            ...
            <handle-site-header .name=${'yo'}></handle-site-header>
            <state-example .name=${'You Clicked'}></state-example>
            <p>
                We recommend building UIs with a
                <a href="https://componentdriven.org" target="_blank" rel="noopener noreferrer"> <strong>component-driven</strong> </a>process starting with atomic components and ending with pages.
            </p>
